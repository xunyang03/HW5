...
class DDPMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        #################################### Important!!!: Check the code below #############################################
        self.alphas = 1.0 - self.betas
        # Tries to look at what torch.cumprod means 
        self.alphas_cumprod = torch.cumprod(self.alphas, dim=0)     # Recommend to use self.alphas, and the dimension should be across 0
        #######################################################################################################################
    ...
    def step(
        ...
        ############################################ TODO #2 ##################################################
        # Implement the Formula (1)
        # Note: pred_original_sample is the clean x0 we want to calculate based on the unet outputs and the timestep information
        ...
        # Add noise (Small Distrubance noise)
        variance = 0
        if t > 0:
